...
//		Product p=new Product();
//		p.setName("A");
//		p.setDescription("hii");
//		
//		productRepo.save(p);
		
		List<Product> pp1=productRepo.findAllByNameAsc(List.of("ritvik","ritvikikk"));
		pp1.forEach((contain)->{
		...
		List<Product> pp2=productRepo.findAllByNameDsc(List.of("ritvik","ritvikikk"));
		pp2.forEach((contain)->{
			System.out.println(contain.getName());
			System.out.println(contain.getDescription());
		});
